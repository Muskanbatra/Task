...
import { ManageTab, parseDurationMinutes, Task } from '../../domain/model';
      ...
      return (
        <View key={task.id} style={styles.taskCard}>
          ...
          <View style={styles.manageSummaryCard}>
            ...
            <MetaPill
              icon="◷"
              text={`Total break taken: ${formatBreakDuration(totalBreakSeconds)}`}
            />
            ...
            <View style={styles.taskTitleRow}>
              ...
              <Text
                style={[
                  styles.badge,
                  styles.manageStatusBadgeCompact,
                  task.status === 'rejected' ? styles.statusDanger : styles.statusReview,
                ]}
              >
